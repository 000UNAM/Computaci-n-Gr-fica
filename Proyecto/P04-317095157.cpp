...
int main()
{
    ...
    while (!mainWindow.getShouldClose())
    {
        ...
        //--------------------------------------------------------------------
        /// Construcción de un modelo jerárquico articulado 
        ///
        /// Objetivo:
        ...
        /// Representa el cuerpo del perro
        ///
        /// Pasos:
        ...
        // Escalar el cubo para formar el cuerpo
        ...
        //--------------------------------------------------------------------
        /// PRIMER ARTICULACIÓN (ESFERA)
        ///
        /// Esta articulación gira respecto al cuerpo
        ///
        /// Pasos:
        ...
        // Trasladar la articulación
        model = glm::translate(model, glm::vec3(-2.0f, 0, 1));

        // Guardar transformación para continuar la jerarquía
        modelaux = model;

        // Escalar para crear la articulación
        ...
        ///
        /// Este segmento gira respecto a la articulación.
        ///
        /// Pasos:
        /// 1. Recuperar transformación base.
        /// 2. Aplicar rotación controlada por el usuario.
        ...
        /// Pasos:
        /// 1. Recuperar transformación base.
        /// 2. Ajustar orientación.
        /// 3. Desplazar el siguiente segmento.
        ///--------------------------------------------------------------------
        ...
        // Desplazar hacia abajo para posicionar el segmento
        model = glm::translate(model, glm::vec3(3, 3.5f, 0));
