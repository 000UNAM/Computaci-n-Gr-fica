...
int main()
{
    ...
    while (!mainWindow.getShouldClose())
    {
        ...
        model = glm::rotate(model, anguloAeolipile * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));  // Giro (Nuevo)
        ...
        // meshList[3] tiene dos planos cruzados, el fuego se ve desde varios ángulos.
